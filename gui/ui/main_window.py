...
from PyQt6.QtWidgets import (
    ...
    QRadioButton, QHeaderView, QAbstractItemView, QTableView
)
...
class MainWindow(QMainWindow):
    ...
    def create_ui_components(self):
        ...
        self.swap_sides_check = QCheckBox("左右の幅員を入れ替える（区間6など）")
        grp_lay.addWidget(self.auto_convert_check)
        grp_lay.addWidget(self.normalize_names_check)
        grp_lay.addWidget(self.swap_sides_check)
    ...
    def preview_data(self):
        ...
        df = self.app_controller.process_section(
            ...
            swap_sides=self.swap_sides_check.isChecked(),
    ...
    def convert_to_dxf(self):
        ...
        if file_path and self.app_controller.convert_to_dxf(file_path):
